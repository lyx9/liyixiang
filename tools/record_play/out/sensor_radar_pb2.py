...
_RADARTYPE = _descriptor.EnumDescriptor(
  ...
  values=[
    ...
    _descriptor.EnumValueDescriptor(
      ...
      type=None),
    _descriptor.EnumValueDescriptor(
      name='CONTINENTAL_SRR_20821', index=2, number=2,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
...
_CONTIRADARSRROBS = _descriptor.Descriptor(
  name='ContiRadarSRRObs',
  full_name='adu.common.sensor.ContiRadarSRRObs',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='header', full_name='adu.common.sensor.ContiRadarSRRObs.header', index=0,
      number=1, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='clusterortrack', full_name='adu.common.sensor.ContiRadarSRRObs.clusterortrack', index=1,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='track_longdispl', full_name='adu.common.sensor.ContiRadarSRRObs.track_longdispl', index=2,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='track_latdispl', full_name='adu.common.sensor.ContiRadarSRRObs.track_latdispl', index=3,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='index', full_name='adu.common.sensor.ContiRadarSRRObs.index', index=4,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='track_id', full_name='adu.common.sensor.ContiRadarSRRObs.track_id', index=5,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='track_vrellong', full_name='adu.common.sensor.ContiRadarSRRObs.track_vrellong', index=6,
      number=8, type=1, cpp_type=5, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='track_vrellat', full_name='adu.common.sensor.ContiRadarSRRObs.track_vrellat', index=7,
      number=9, type=1, cpp_type=5, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='track_lifetime', full_name='adu.common.sensor.ContiRadarSRRObs.track_lifetime', index=8,
      number=10, type=1, cpp_type=5, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='rcs', full_name='adu.common.sensor.ContiRadarSRRObs.rcs', index=9,
      number=11, type=1, cpp_type=5, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='cluster_range', full_name='adu.common.sensor.ContiRadarSRRObs.cluster_range', index=10,
      number=12, type=1, cpp_type=5, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='cluster_azimuth', full_name='adu.common.sensor.ContiRadarSRRObs.cluster_azimuth', index=11,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='cluster_vrel', full_name='adu.common.sensor.ContiRadarSRRObs.cluster_vrel', index=12,
      number=14, type=1, cpp_type=5, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_RADAROBSARRAY = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='contisrrobs', full_name='adu.common.sensor.RadarObsArray.contisrrobs', index=5,
...
_DELPHIRADAROBS.fields_by_name['header'].message_type = header_pb2._HEADER
_CONTIRADAROBS.fields_by_name['header'].message_type = header_pb2._HEADER
_CONTIRADARSRROBS.fields_by_name['header'].message_type = header_pb2._HEADER
_ULTRASONIC.fields_by_name['header'].message_type = header_pb2._HEADER
_RADAROBSARRAY.fields_by_name['header'].message_type = header_pb2._HEADER
...
_RADAROBSARRAY.fields_by_name['contisrrobs'].message_type = _CONTIRADARSRROBS
...
DESCRIPTOR.message_types_by_name['ContiRadarSRRObs'] = _CONTIRADARSRROBS
...
ContiRadarSRRObs = _reflection.GeneratedProtocolMessageType('ContiRadarSRRObs', (_message.Message,), dict(
  DESCRIPTOR = _CONTIRADARSRROBS,
  __module__ = 'sensor_radar_pb2'
  # @@protoc_insertion_point(class_scope:adu.common.sensor.ContiRadarSRRObs)
  ))
_sym_db.RegisterMessage(ContiRadarSRRObs)
