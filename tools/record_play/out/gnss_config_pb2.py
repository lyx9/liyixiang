...
_STREAM_BDNTRIP = _descriptor.Descriptor(
  name='BDNtrip',
  full_name='cybertron.proto.Stream.BDNtrip',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='domain', full_name='cybertron.proto.Stream.BDNtrip.domain', index=0,
      number=1, type=12, cpp_type=9, label=1,
      has_default_value=False, default_value=_b(""),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='port', full_name='cybertron.proto.Stream.BDNtrip.port', index=1,
      number=2, type=5, cpp_type=1, label=1,
      has_default_value=True, default_value=2101,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='mount_point', full_name='cybertron.proto.Stream.BDNtrip.mount_point', index=2,
      number=3, type=12, cpp_type=9, label=1,
      has_default_value=False, default_value=_b(""),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='user', full_name='cybertron.proto.Stream.BDNtrip.user', index=3,
      number=4, type=12, cpp_type=9, label=1,
      has_default_value=False, default_value=_b(""),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='password', full_name='cybertron.proto.Stream.BDNtrip.password', index=4,
      number=5, type=12, cpp_type=9, label=1,
      has_default_value=False, default_value=_b(""),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='httpdns_domain', full_name='cybertron.proto.Stream.BDNtrip.httpdns_domain', index=5,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='default_vip_list', full_name='cybertron.proto.Stream.BDNtrip.default_vip_list', index=6,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='ssl_certificate_file', full_name='cybertron.proto.Stream.BDNtrip.ssl_certificate_file', index=7,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='ssl_private_key_file', full_name='cybertron.proto.Stream.BDNtrip.ssl_private_key_file', index=8,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='ssl_cacert_file', full_name='cybertron.proto.Stream.BDNtrip.ssl_cacert_file', index=9,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='timeout_s', full_name='cybertron.proto.Stream.BDNtrip.timeout_s', index=10,
...
_STREAM = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='bdntrip', full_name='cybertron.proto.Stream.bdntrip', index=5,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='push_location', full_name='cybertron.proto.Stream.push_location', index=6,
  ...
  nested_types=[_STREAM_SERIAL, _STREAM_TCP, _STREAM_UDP, _STREAM_NTRIP, _STREAM_BDNTRIP, ],
  enum_types=[
    _STREAM_FORMAT,
  ],
  options=None,
...
_GNSS_CONFIG = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='device_file', full_name='cybertron.proto.Gnss_Config.device_file', index=12,
...
_STREAM_BDNTRIP.containing_type = _STREAM
...
_STREAM.fields_by_name['bdntrip'].message_type = _STREAM_BDNTRIP
...
_STREAM.oneofs_by_name['type'].fields.append(
  _STREAM.fields_by_name['bdntrip'])
_STREAM.fields_by_name['bdntrip'].containing_oneof = _STREAM.oneofs_by_name['type']
...
_RAWDATA.fields_by_name['cyber_header'].message_type = cyber_header_pb2._CYBERHEADER
...
Stream = _reflection.GeneratedProtocolMessageType('Stream', (_message.Message,), dict(
  ...
  BDNtrip = _reflection.GeneratedProtocolMessageType('BDNtrip', (_message.Message,), dict(
    DESCRIPTOR = _STREAM_BDNTRIP,
    __module__ = 'gnss_config_pb2'
    # @@protoc_insertion_point(class_scope:cybertron.proto.Stream.BDNtrip)
    ))
  ,
  DESCRIPTOR = _STREAM,
  __module__ = 'gnss_config_pb2'
...
_sym_db.RegisterMessage(Stream.BDNtrip)
