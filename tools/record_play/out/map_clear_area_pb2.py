...
_CLEARAREA.fields_by_name['id'].message_type = map_id_pb2._ID
_CLEARAREA.fields_by_name['overlap_id'].message_type = map_id_pb2._ID
_CLEARAREA.fields_by_name['polygon'].message_type = map_geometry_pb2._POLYGON
