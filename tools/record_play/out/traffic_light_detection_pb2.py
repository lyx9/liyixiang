...
_TRAFFICLIGHTDETECTION_CAMERAID = _descriptor.EnumDescriptor(
  name='CameraID',
  full_name='adu.common.traffic_light.TrafficLightDetection.CameraID',
  filename=None,
  file=DESCRIPTOR,
  values=[
    _descriptor.EnumValueDescriptor(
...
_TRAFFICLIGHTBOX = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='camera_name', full_name='adu.common.traffic_light.TrafficLightBox.camera_name', index=6,
...
_TRAFFICLIGHTDEBUG = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='crop_roi', full_name='adu.common.traffic_light.TrafficLightDebug.crop_roi', index=8,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='projected_roi', full_name='adu.common.traffic_light.TrafficLightDebug.projected_roi', index=9,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='rectified_roi', full_name='adu.common.traffic_light.TrafficLightDebug.rectified_roi', index=10,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='debug_roi', full_name='adu.common.traffic_light.TrafficLightDebug.debug_roi', index=11,
...
_TRAFFICLIGHT = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='blink', full_name='adu.common.traffic_light.TrafficLight.blink', index=4,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='remaining_time', full_name='adu.common.traffic_light.TrafficLight.remaining_time', index=5,
      number=6, type=1, cpp_type=5, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_TRAFFICLIGHTDETECTION = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='camera_id', full_name='adu.common.traffic_light.TrafficLightDetection.camera_id', index=4,
      number=5, type=14, cpp_type=8, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_TRAFFICLIGHTDETECTION.fields_by_name['header'].message_type = header_pb2._HEADER
