...
_IMU.fields_by_name['header'].message_type = header_pb2._HEADER
_IMU.fields_by_name['linear_acceleration'].message_type = common_geometry_pb2._POINT3D
_IMU.fields_by_name['angular_velocity'].message_type = common_geometry_pb2._POINT3D
